/*
 ...
 Source Schema         : django_axf

 Target Server Type    : MySQL
 Target Server Version : 50722
 File Encoding         : 65001

 Date: 10/07/2018 09:45:05
*/
...
CREATE TABLE `axf_cart`  (
  ...
  INDEX `axf_cart_c_goods_id_85ddfb56_fk_axf_goods_id`(`c_goods_id`) USING BTREE,
  INDEX `axf_cart_c_user_id_5abdebfe_fk_axf_user_id`(`c_user_id`) USING BTREE,
  CONSTRAINT `axf_cart_c_goods_id_85ddfb56_fk_axf_goods_id` FOREIGN KEY (`c_goods_id`) REFERENCES `axf_goods` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `axf_cart_c_user_id_5abdebfe_fk_axf_user_id` FOREIGN KEY (`c_user_id`) REFERENCES `axf_user` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 28 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of axf_cart
-- ----------------------------
INSERT INTO `axf_cart` VALUES (24, 1, 11, 495, 11);
INSERT INTO `axf_cart` VALUES (25, 1, 5, 496, 11);
INSERT INTO `axf_cart` VALUES (26, 1, 3, 73, 11);
INSERT INTO `axf_cart` VALUES (27, 1, 3, 74, 11);
...
CREATE TABLE `axf_foodtypes`  (
  ...
  `typename` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `childtypenames` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `axf_goods`  (
  ...
  `productimg` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `productname` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `productlongname` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `isxf` tinyint(1) NOT NULL,
  `pmdesc` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `specifics` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `price` double NOT NULL,
  `marketprice` double NOT NULL,
  `categoryid` int(11) NOT NULL,
  `childcid` int(11) NOT NULL,
  `childcidname` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `axf_mainshow`  (
  ...
  `img1` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `childcid1` int(11) NOT NULL,
  `productid1` int(11) NOT NULL,
  `longname1` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `price1` double NOT NULL,
  `marketprice1` double NOT NULL,
  `img2` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `childcid2` int(11) NOT NULL,
  `productid2` int(11) NOT NULL,
  `longname2` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `price2` double NOT NULL,
  `marketprice2` double NOT NULL,
  `img3` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `childcid3` int(11) NOT NULL,
  `productid3` int(11) NOT NULL,
  `longname3` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `axf_order`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `axf_order_o_user_id_a23247bb_fk_axf_user_id`(`o_user_id`) USING BTREE,
  CONSTRAINT `axf_order_o_user_id_a23247bb_fk_axf_user_id` FOREIGN KEY (`o_user_id`) REFERENCES `axf_user` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of axf_order
-- ----------------------------
INSERT INTO `axf_order` VALUES (1, 165.9, 0, '2018-07-09', 11);
INSERT INTO `axf_order` VALUES (2, 26.7, 1, '2018-07-09', 11);
INSERT INTO `axf_order` VALUES (3, 35.6, 0, '2018-07-09', 11);
INSERT INTO `axf_order` VALUES (4, 71, 0, '2018-07-09', 11);
...
CREATE TABLE `axf_ordergoods`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `axf_ordergoods_o_goods_id_f5c54400_fk_axf_goods_id`(`o_goods_id`) USING BTREE,
  INDEX `axf_ordergoods_o_order_id_35bb0edb_fk_axf_order_id`(`o_order_id`) USING BTREE,
  CONSTRAINT `axf_ordergoods_o_goods_id_f5c54400_fk_axf_goods_id` FOREIGN KEY (`o_goods_id`) REFERENCES `axf_goods` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `axf_ordergoods_o_order_id_35bb0edb_fk_axf_order_id` FOREIGN KEY (`o_order_id`) REFERENCES `axf_order` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of axf_ordergoods
-- ----------------------------
INSERT INTO `axf_ordergoods` VALUES (1, 60, 495, 1);
INSERT INTO `axf_ordergoods` VALUES (2, 7, 497, 1);
INSERT INTO `axf_ordergoods` VALUES (3, 8, 555, 1);
INSERT INTO `axf_ordergoods` VALUES (4, 3, 277, 1);
INSERT INTO `axf_ordergoods` VALUES (5, 3, 496, 2);
INSERT INTO `axf_ordergoods` VALUES (6, 4, 496, 3);
INSERT INTO `axf_ordergoods` VALUES (7, 15, 495, 4);
INSERT INTO `axf_ordergoods` VALUES (8, 4, 496, 4);
...
CREATE TABLE `axf_user`  (
  ...
  `u_email` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `u_icon` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `is_active` tinyint(1) NOT NULL,
  `is_delete` tinyint(1) NOT NULL,
  `u_password` varchar(256) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
...
-- Records of axf_user
-- ----------------------------
INSERT INTO `axf_user` VALUES (11, 'liuyuan', '1120793140@qq.com', 'icons/6044abce24313bb8d2883aadab6336235f3578a7_PRtzx3l.jpg', 1, 0, 'pbkdf2_sha256$36000$vWWpbqxFHyr5$BK6Sd61kA2nlKcXki4V8NrjcG/N6eTfabY/AjDtKFk0=');
INSERT INTO `axf_user` VALUES (23, 'liuyuan1', '942784595@qq.com', 'icons/6044abce24313bb8d2883aadab6336235f3578a7_ODLnmj7.jpg', 0, 0, 'pbkdf2_sha256$36000$sZls42CAa7ut$iv3f9AiTuCt7iBQQXA1DdLw5J4++CkXFTYo4c+uzKqw=');
